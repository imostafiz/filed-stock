...
const FilterSidebar = ({ categories }: FilterSidebarProps) => {
  return (
    <aside className="hidden w-56 shrink-0 self-start lg:block lg:sticky lg:top-28">
      <div className="space-y-6 rounded-2xl border border-gray-100 bg-white p-4 shadow-sm">
